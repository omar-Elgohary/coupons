...
<div class="h-screen flex bg-gray-200">
    ...
    <div class="container mx-auto">
        <h1 class="text-2xl mb-3 mt-3 font-bold">قائمة الدول</h1>
    </div>
        ...
        <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <table class="min-w-full">
                ...
                <tr class="text-center">
                    ...
                    <th class="text-base font-semibold text-gray-900 px-6 py-4 text-righ">المعرف
                    </th>
                    <th class="text-base font-semibold text-gray-900 px-6 py-4 text-righ">
                    عدد القسائم
                    </th>
            ...
            @foreach($countries as $key => $item)
                <tbody id="data">
                    <tr class="text-center bg-gray-100 border-b r">
                        ...
                        <td class="text-base font-medium text-gray-900 px-6 py-4 text-center whitespace-nowrap">{{$item->iso2}}</td>
                        <td class="text-base font-medium text-gray-900 px-6 py-4 text-center whitespace-nowrap">
                            {{$item->coupons->count()}}
                        </td>
                        ...
                        <button
                            ...
                            href="{{route('showCountry', $item->id)}}">عرض</a></button>
                        </td>
                    </tr>
                </tbody>
                @endforeach
